 ...
 * Overwrite confirmation (if the user already has manually-set values)
 * happens client-side before this is ever called — this endpoint always
 * just does what's asked.
 */
