...
const DOCUMENT_TYPE_ICON_CONFIG: Record<
  DocumentType,
...
> = {
  ...
  youtube_script: { icon: Video, className: "bg-red-50 text-red-500" },
  linkedin_post: { icon: Share2, className: "bg-blue-50 text-blue-500" },
  newsletter: { icon: Mail, className: "bg-amber-50 text-amber-600" },
  article: { icon: Newspaper, className: "bg-slate-100 text-slate-600" },
  summary: { icon: ListChecks, className: "bg-emerald-50 text-emerald-600" },
};
